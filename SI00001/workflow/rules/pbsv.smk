...
rule pbsv_call_5X_pbmm2:
    ...
    output:
        f"{RESULTDIR}/pbmm2/pbsv/5X/SI00001.vcf"
    log:
...
rule pbsv_call_10X_pbmm2:
    ...
    output:
        f"{RESULTDIR}/pbmm2/pbsv/10X/SI00001.vcf"
    log:
...
rule pbsv_call_15X_pbmm2:
    ...
    output:
        f"{RESULTDIR}/pbmm2/pbsv/15X/SI00001.vcf"
    log:
...
rule pbsv_call_20X_pbmm2:
    ...
    output:
        f"{RESULTDIR}/pbmm2/pbsv/20X/SI00001.vcf"
    log:
...
rule pbsv_call_25X_pbmm2:
    ...
    output:
        f"{RESULTDIR}/pbmm2/pbsv/25X/SI00001.vcf"
    log:
...
rule pbsv_call_35X_pbmm2:
    ...
    output:
        f"{RESULTDIR}/pbmm2/pbsv/35X/SI00001.vcf"
    log:
