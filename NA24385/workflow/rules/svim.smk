...
rule svim_call_5X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/svim/5X/GM24385.vcf"
    log:
...
rule svim_call_10X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/svim/10X/GM24385.vcf"
    log:
...
rule svim_call_15X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/svim/15X/GM24385.vcf"
    log:
...
rule svim_call_20X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/svim/20X/GM24385.vcf"
    log:
...
rule svim_call_25X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/svim/25X/GM24385.vcf"
    log:
...
rule svim_call_35X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/svim/35X/GM24385.vcf"
    log:
