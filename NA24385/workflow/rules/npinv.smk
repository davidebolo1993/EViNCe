...
rule npinv_call_5X_minimap2:
    ...
    output:
        f"{RESULTDIR}/minimap2/npinv/5X/GM24385.vcf"
    log:
...
rule npinv_call_5X_ngmlr:
    ...
    output:
        f"{RESULTDIR}/ngmlr/npinv/5X/GM24385.vcf"
    log:
...
rule npinv_call_10X_minimap2:
    ...
    output:
        f"{RESULTDIR}/minimap2/npinv/10X/GM24385.vcf"
    log:
...
rule npinv_call_10X_ngmlr:
    ...
    output:
        f"{RESULTDIR}/ngmlr/npinv/10X/GM24385.vcf"
    log:
...
rule npinv_call_15X_minimap2:
    ...
    output:
        f"{RESULTDIR}/minimap2/npinv/15X/GM24385.vcf"
    log:
...
rule npinv_call_15X_ngmlr:
    ...
    output:
        f"{RESULTDIR}/ngmlr/npinv/15X/GM24385.vcf"
    log:
...
rule npinv_call_20X_minimap2:
    ...
    output:
        f"{RESULTDIR}/minimap2/npinv/20X/GM24385.vcf"
    log:
...
rule npinv_call_20X_ngmlr:
    ...
    output:
        f"{RESULTDIR}/ngmlr/npinv/20X/GM24385.vcf"
    log:
...
rule npinv_call_25X_minimap2:
    ...
    output:
        f"{RESULTDIR}/minimap2/npinv/25X/GM24385.vcf"
    log:
...
rule npinv_call_25X_ngmlr:
    ...
    output:
        f"{RESULTDIR}/ngmlr/npinv/25X/GM24385.vcf"
    log:
...
rule npinv_call_35X_minimap2:
    ...
    output:
        f"{RESULTDIR}/minimap2/npinv/35X/GM24385.vcf"
    log:
...
rule npinv_call_35X_ngmlr:
    ...
    output:
        f"{RESULTDIR}/ngmlr/npinv/35X/GM24385.vcf"
    log:
