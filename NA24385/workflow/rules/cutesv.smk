...
rule cutesv_call_5X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/cutesv/5X/GM24385.vcf"
    log:
...
rule cutesv_call_10X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/cutesv/10X/GM24385.vcf"
    log:
...
rule cutesv_call_15X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/cutesv/15X/GM24385.vcf"
    log:
...
rule cutesv_call_20X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/cutesv/20X/GM24385.vcf"
    log:
...
rule cutesv_call_25X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/cutesv/25X/GM24385.vcf"
    log:
...
rule cutesv_call_35X_lra:
    ...
    output:
        f"{RESULTDIR}/lra/cutesv/35X/GM24385.vcf"
    log:
