...
ggsave(file.path(args[1], 'GM24385.minimap2.upset.pdf'), width=20, height=15)
...
ggsave(file.path(args[1], 'GM24385.ngmlr.upset.pdf'), width=20, height=15)
...
ggsave(file.path(args[1], 'GM24385.lra.upset.pdf'), width=20, height=15)
