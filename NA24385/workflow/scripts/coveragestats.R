...
#minimap2 and ngmlr plot, fraction of bases per depth treshold
message("Plotting proportions of genome at coverage")

files<-c(file.path(args[1], "GM24385.minimap2.mosdepth.global.dist.txt"), file.path(args[1], "GM24385.ngmlr.mosdepth.global.dist.txt"))
...
labels_<-c("minimap2", "ngmlr")
colors_<-c("darkred", "darkblue")
